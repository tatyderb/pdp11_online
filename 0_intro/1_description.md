...
Мы написали эмулятор этого "примитивного компьютера", научились дизассемблировать (разбирать) его байт-код (закодированную программу) и исполнять его.

У PDP-11 больше регистров, дополнительные ячейки памяти, иные правила кодирования и расширенный набор команд.

Но основные принципы остаются теми же. Как видите, все просто.

Пора начать работу над эмулятором PDP-11, описать его "память" и реализовать функции для работы с ней. Для начала стоит разобраться с базовыми понятиями компьютерной архитектуры.

...
Подсказка: Если у вас копируются одинаковые тесты с разными данными или разными адресами, напишите функцию, которая выполняет весь набор тестов с указанного адреса для переданного слова и двух байт.
